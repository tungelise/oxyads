...
export const WATCH_VIDEO = 'VIDEO_OPTIONS/WATCH_VIDEO';
export const WATCH_VIDEO_SET_POINT = 'VIDEO_OPTIONS/SET_POINT';
...
export const setWatchVideo = videoId => ({
    type: WATCH_VIDEO,
    videoId
});

export const setWatchVideoPoint = nbPoint => ({
    type: WATCH_VIDEO_SET_POINT,
    nbPoint
});
...
export default function reducer(state = {
    ...
    switch (action.type) {
        ...
        case SET_ENABLE_CLOSED_SIDEBAR:
            console.log('change enableClosedSidebar');
            return {
                ...state,
        ...
        case WATCH_VIDEO:
            console.log('change watch video');
            return {
                ...state,
                watchVideo: action.videoId
            }

        case WATCH_VIDEO_SET_POINT:
            return {
                ...state,
                nbPoint: action.nbPoint
            }
    }
    return state;
}